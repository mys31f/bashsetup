...
sudo dnf install https://download.cdn.viber.com/desktop/Linux/viber.rpm https://d11yldzmag5yn.cloudfront.net/prod/5.3.469451.0927/zoom_x86_64.rpm https://www.softmaker.net/down/softmaker-freeoffice-2018-982.x86_64.rpm https://dl.google.com/linux/direct/google-chrome-stable_current_x86_64.rpm -y
