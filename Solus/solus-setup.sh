...
sudo eopkg install steam lutris wine obs-studio discord kdenlive gimp krita blender inkscape audacity viber telegram-desktop -y
...
installfreeoffice
rm -r softmaker-freeoffice-978-amd64
